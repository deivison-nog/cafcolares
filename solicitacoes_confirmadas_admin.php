...
if (!isset($_GET['medicamentos']) || !isset($_GET['quantidades']) || !isset($_GET['data']) || !isset($_GET['usuarios'])) {
...
$usuarios = urldecode($_GET['usuarios']);
?>
...
<body>
    ...
    <div class="container">
        <div class="main-content">
            ...
            <center>
                <h2 style="text-transform: uppercase;">Solicitação de Medicamentos do <?php echo htmlspecialchars($usuarios, ENT_QUOTES, 'UTF-8'); ?></h2>
            </center>
